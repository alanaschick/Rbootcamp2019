...
This section uses data from a long term evolution experiment published in 2016: Tempo and mode of genome evolution in a 50,000-generation experiment by [Tenaillon et al](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4988878/).
...
Investigate the structure of the data frame using the `str()` function:
```{r}
str(variants)
```
...
<div class = "box">
### EXERCISE
With all of this information in hand, please take another five minutes to either improve one of the plots generated in this exercise or create a beautiful graph of your own. Here are some ideas:
