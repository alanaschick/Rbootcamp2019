...
<div class="box">
### EXERCISE
Exercise: write a simple if...else statement to check if 5 is an odd number and if it is print "I am odd", otherwise print "I am even".
</div>
...
<div class="box">
### EXERCISE
**Challenging.** Using the *E. coli* metadata from the last section, write a for loop containing an if...else statement to change the genome size into categorical variable. 

Do this by translating the following sentence into R: for every element in the genome_size variable, if the genome size is greater than the mean, change it to "large", otherwise, change it to "small".
</div>
